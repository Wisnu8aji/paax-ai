 ...
 * lookup_ahsp, run_scenario, analyze_drawing, dst) secara in-process — BUKAN HTTP call
...
function buildToolRegistry(): ToolDefinition[] {
  ...
  return tools.filter((t) => t.declaration.name !== "search_knowledge");
}
