// Proxy tipis ke DB API (services/db) untuk daftar/CRUD proyek (lib/projects/db-api.ts).
// Mengikuti pola apps/web/src/app/api/core-engine/[...path]/route.ts dan
// apps/web/src/app/api/drawing-intelligence/[...path]/route.ts — hanya meneruskan
