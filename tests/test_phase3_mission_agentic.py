...
import pytest
from paax_db.package_index import build_package_index_from_dem_pages
...
def test_agentic_workflow_receipt_and_completeness():
    ...
    assert payload["schema_version"] == "2.0-live"
...
def test_drawing_package_index_completeness():
    """Verify 88-page Drawing Package Index contains 0 unassigned plans."""
    ...
    assert manifest["unassigned_count"] == 0
