...
import {
  ...
  SheetViewsSchema,
  RawEvidenceArtifactSchema,
  EvidenceRegionSchema,
  SourceAuthorityEntrySchema,
  CanonicalFactSchema,
  PropagationScopeSchema,
...
describe("ContextualEvidenceSchemas", () => {
  ...
  it("parses valid contextual evidence JSON fixture", () => {
    ...
    expect(PropagationScopeSchema.parse(validData.propagation_scope).match_mode).toBe("exact");
