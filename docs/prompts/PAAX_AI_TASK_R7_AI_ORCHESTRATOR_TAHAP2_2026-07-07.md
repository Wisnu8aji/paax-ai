# PROMPT SAYA — Task R7: AI-Orchestrator Tahap 2 (Context Server-Side, Streaming, Audit Log)

> Ditulis Saya, 2026-07-07, reasoning tinggi. Bagian dari
> `docs/prompts/PAAX_SAYA_ROADMAP_10_TASKS_NON_UI_2026-07-07.md` (Task 7).
> **WAJIB dikerjakan SETELAH** `PAAX_SAYA_TASK_R6_DATABASE_SERVER_SIDE_
...
audit log gagal ditulis, log error saja). Ini amanat `SAYA.md` §1.1
...
Nama file baru: `report-remote/REPORT_TASKR7_ORCHESTRATOR_TAHAP2_SAYA_<tanggal>.md`.
