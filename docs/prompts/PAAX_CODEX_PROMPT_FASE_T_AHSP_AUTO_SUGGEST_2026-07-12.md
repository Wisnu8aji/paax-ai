# PROMPT CODEX — Fase T: Nyalakan AHSP Auto-Suggest (akhirnya tidak diblokir lagi)

> Ditulis Claude, 2026-07-12. Ini **tugas besar berikutnya**, bukan
> housekeeping kecil (itu ada di prompt terpisah `PAAX_CODEX_PROMPT_FASE_S_
> CLOSE_SEMARANG_MATCHER_REFINEMENT_2026-07-12.md`). Fase L (AHSP
> auto-suggest) sudah 2x sengaja di-skip Codex sebelumnya (prompt 07-06 &
...
1. `CLAUDE.md` §1 (Aturan Emas) — **penting utk fase ini**: AHSP mapping
...
2. `docs/prompts/PAAX_CODEX_PROMPT_FASE_J_GENERATE_RAB_WIRING_2026-07-06.md`
