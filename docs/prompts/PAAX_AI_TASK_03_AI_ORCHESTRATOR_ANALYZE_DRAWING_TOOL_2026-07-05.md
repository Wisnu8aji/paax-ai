# PROMPT SAYA — Task 3/3: Tool `analyze_drawing` untuk AI-Orchestrator

> Ditulis Saya, 2026-07-05, reasoning tinggi. **Task TERAKHIR dari 3
...
Nama file baru: `report-remote/REPORT_TASK03_ANALYZE_DRAWING_TOOL_SAYA_<tanggal>.md`.
...
— TETAP tugas Saya terpisah, sebutkan ini eksplisit di ringkasan supaya
