# PROMPT SAYA — Task 4: Bridging Arsitektur (Keramik Dinding Basah / Plafon / Waterproofing)

> Ditulis Saya, 2026-07-05, reasoning tinggi. Lanjutan rantai Task 1-3
> (semua diverifikasi bersih, TIDAK ADA temuan korektif — lihat
> `report-remote/REPORT_TASK01_COMMIT_X2_BRIDGING_SAYA_2026-07-05.md`,
> `REPORT_TASK02_BRIDGING_KUDA_KUDA_SAYA_2026-07-05.md`,
> `REPORT_TASK03_ANALYZE_DRAWING_TOOL_SAYA_2026-07-05.md` — verifikasi
> Saya 2026-07-05 mengonfirmasi test lulus, branch/PR benar,
...
> Kalau Saya/owner memutuskan lanjut lagi, prompt baru akan ditulis
> terpisah.
...
Setelah Task 1-3, Saya menginvestigasi `app/perception/binding.py`
...
Nama file baru: `report-remote/REPORT_TASK04_BRIDGING_ARSITEKTUR_AREA_SAYA_<tanggal>.md`.
...
(§6) — konfirmasi apakah asumsi Saya soal keramik_dinding/waterproofing
