# PROMPT SAYA — AI Multimodal: Lampiran Chat + (opsional) Vision Gambar Kerja (2026-07-03)
...
> bawah.** Ini prompt TERPISAH dari `PAAX_SAYA_PROMPT_PERBAIKAN_UI_BATCH_2026-07-03.md`
...
> eksplisit (Bagian B), bukan diasumsikan oleh Saya.
...
dilampirkan user — SAMA seperti Saya/ChatGPT. Chat hanya MENJELASKAN
...
**Kondisi sekarang** (sudah diverifikasi Saya, jujur ditulis di kode):
...
digerbang eksplisit di `docs/BRAIN_ALIGNMENT.md` (ditulis owner+Saya,
...
### Kotak persetujuan (isi sebelum menyuruh Saya jalan)
...
**Saya: kalau kotak di atas belum dicentang salah satu, JANGAN kerjakan
