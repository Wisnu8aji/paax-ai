# PROMPT CODEX — Commit & PR: Review PLHUT + Triage UI + Data Surakarta (2026-07-03)

> Claude selesai me-review & MEMPERBAIKI hasil sesi PLHUT-mu (rincian:
> `report/REVIEW_CLAUDE_PLHUT_2026-07-03.md`) + membangun Triage UI + data
...
2. DILARANG stage: `.claude/`, `skills-lock.json`, `excel_extracted.txt`,
...
## Commit 4 — `docs: PLHUT session reports + Claude critical review`
- `report/ANALISIS_PLHUT_DAN_TASK_LANJUTAN.md`
- `report/PROMPT_UNTUK_CLAUDE.md`
- `report/REPORT_PLHUT_CODEX_SESSION.md`
- `report/REVIEW_CLAUDE_PLHUT_2026-07-03.md`
- `docs/prompts/PAAX_CODEX_PROMPT_PLHUT_REVIEW.md`
- `report/REPORT_PLHUT_COMMIT_CODEX_2026-07-03.md` (tulis: hasil guardrail + URL PR)
...
gh pr create --draft --base main \
  ...
  --body "<ringkas dari report/REVIEW_CLAUDE_PLHUT_2026-07-03.md §1-2 + hasil guardrail>"
```
Catatan body PR: sebutkan bahwa branch ini memuat batch engine brain v4.1 +
sesi PLHUT + perbaikan review Claude; stack PR lama (#20/#21/#22) di-supersede
