# PROMPT CODEX — FASE 2 · PAKET P5-FIX: Perbaikan Terarah Panel Review Persepsi

> ## ⚠️ STATUS: HISTORIS / SUPERSEDED (2026-07-04 malam)
> Owner memutuskan Claude mengerjakan paket ini LANGSUNG. **SUDAH
...
> nyata. **JANGAN jalankan prompt ini via Codex.** Lihat status nyata di
> `docs/plans/PAAX_FASE2_PERSEPSI_PLAN_2026-07-04.md` §Paket F2-P5-FIX.

> Ditulis Claude 2026-07-04 setelah audit hasil kerja hari ini. Rencana induk:
...
Audit Claude menemukan `buildPerceptionReview()` di
...
- **Kerjakan LANGSUNG di branch `feat/ui-premium-redesign`** (branch yang
  ...
  pengecualian dari aturan "branch baru → PR" (CLAUDE.md §9); PR #26 SUDAH
...
- Report → `report/REPORT_FASE2_P5_FIX_CODEX_2026-07-04.md`: ringkas 3
