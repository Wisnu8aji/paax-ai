# PROMPT SAYA — Task 2/3: Bridging Kuda-Kuda (Rangka Utama Baja Profil)

> Ditulis Saya, 2026-07-05, reasoning tinggi. **Kerjakan SETELAH Task 1**
> (`PAAX_SAYA_TASK_01_COMMIT_X2_BRIDGING_NONSTRUKTUR_2026-07-05.md`)
...
> lanjut ke** `docs/prompts/PAAX_SAYA_TASK_03_AI_ORCHESTRATOR_ANALYZE_DRAWING_TOOL_2026-07-05.md`
...
Laporan Fase X2 lanjutan (`report-remote/REPORT_X2_LANJUTAN_ATAP_SAYA_
...
- `services/core-engine/app/takeoff/models.py` — cari `class BajaMember`,
  `class ProfileData`, `class BajaRequest` (sudah dikonfirmasi Saya ada
  ...
  ```
- `ProfileData` (cari definisinya persis, field yang dikonfirmasi Saya
...
Nama file baru: `report-remote/REPORT_TASK02_BRIDGING_KUDA_KUDA_SAYA_<tanggal>.md`.
...
- Commit HANYA Saya, TANPA `Co-Authored-By`/signature AI.
