# PROMPT CODEX — Perbaikan Nyata Packaging `paax_schemas` + Investigasi Binding Dimensi Footplat (Fase X-1b)

> Ditulis Claude, 2026-07-16, reasoning tinggi ("extra") sesuai instruksi owner
...
> `report-remote/REPORT_FASE_X1_BRIDGING_GALIAN_CODEX_2026-07-05.md` (hasil
> `docs/prompts/PAAX_CODEX_PROMPT_FASE_X1_BRIDGING_GALIAN_FIX_ARSITEKTUR_
...
- `report-remote/REPORT_FASE_V_W_CODEX_2026-07-05.md` (report sesi
...
container terpisah (rencana arsitektur resmi proyek ini, `CLAUDE.md` §4:
...
- Di `services/core-engine/pyproject.toml` DAN
  ...
  kalau repo belum pakai itu, konsisten §2 CLAUDE.md "jangan menambah
...
owner/Claude, jangan kembali diam-diam ke pola `sys.path` hack.
...
- **Codex**: §1 + §2 sepenuhnya (backend, packaging, test). Commit HANYA
  oleh Codex, auto-run tetap berlaku (tanpa minta approval tiap langkah).
...
- **Claude**: frontend sepenuhnya di luar cakupan, dikerjakan terpisah
...
Nama file baru: `report-remote/REPORT_FASE_X1B_PACKAGING_BINDING_CODEX_
<tanggal-eksekusi-nyata>.md`. **JANGAN edit/hapus report lama yang sudah
ada** (`REPORT_FASE_V_W_CODEX_2026-07-05.md`,
