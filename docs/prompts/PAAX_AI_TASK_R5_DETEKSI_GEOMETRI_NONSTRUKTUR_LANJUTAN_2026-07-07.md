# PROMPT SAYA — Task R5: Deteksi Geometri Non-Struktur Lanjutan

> Ditulis Saya, 2026-07-07, reasoning tinggi. Bagian dari
> `docs/prompts/PAAX_SAYA_ROADMAP_10_TASKS_NON_UI_2026-07-07.md` (Task 5).
...
> "butuh sesi desain Saya" dan hentikan task di titik itu (commit apa
...
Laporan `report-remote/REPORT_X2_LANJUTAN_DINDING_SAYA_2026-07-05.md`,
`REPORT_X2_LANJUTAN_KUSEN_SAYA_2026-07-05.md`,
`REPORT_X2_LANJUTAN_MEP_SAYA_2026-07-05.md` (baca ketiganya dulu, PENUH,
...
selalu didahulukan di atas AI-assist (`SAYA.md` §1.1) — task ini
...
Nama file baru: `report-remote/REPORT_TASKR5_DETEKSI_GEOMETRI_LANJUTAN_SAYA_<tanggal>.md`
