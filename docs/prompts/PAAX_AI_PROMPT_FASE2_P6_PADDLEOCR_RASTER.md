# PROMPT SAYA — FASE 2 · PAKET P6: Perception Raster via PaddleOCR (sheet scan/foto)

> ## ⚠️ STATUS: HISTORIS / SUPERSEDED (2026-07-04 malam)
> Owner memutuskan Saya mengerjakan paket ini LANGSUNG. **KODE SUDAH
...
> prompt ini via Saya** untuk membangun ulang; kalau ingin lanjut ke modul
...
> Ditulis Saya 2026-07-04. Rencana induk:
...
**PRASYARAT KERAS: Paket P1 (`docs/prompts/PAAX_SAYA_PROMPT_FASE2_P1_FONDASI_PERSEPSI.md`)
HARUS SUDAH SELESAI & DI-REVIEW Saya sebelum paket ini dimulai** — P6
...
3. **Dependency BERAT & OPSIONAL, bukan wajib.** `paddleocr` bergantung pada
   ...
   menjatuhkan endpoint (selaras SAYA.md §2: fitur AI baru wajib fallback).
...
5. (Bila `paddleocr` benar-benar terpasang di environment CI/lokal Saya —
...
- Report → `report/REPORT_FASE2_P6_SAYA_2026-07-04.md`: konfirmasi eksplisit
