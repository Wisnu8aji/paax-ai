# PROMPT CODEX — Task R11: Metering & Observabilitas Biaya AI

> Ditulis Claude, 2026-07-07, reasoning tinggi. Bagian dari
> `docs/prompts/PAAX_CODEX_ROADMAP_10_TASKS_NON_UI_2026-07-07.md` (Task 11).
...
Response cukup untuk nanti ditampilkan UI (domain Claude, di luar scope
...
(`CLAUDE.md` §2). Reset kuota: kolom `reset_at`, dicek/direset saat
...
Nama file baru: `report-remote/REPORT_TASKR11_METERING_OBSERVABILITAS_CODEX_<tanggal>.md`.
