# PROMPT SAYA — Sesi TKG (brain v4.1), 2026-07-02

> Salin-tempel per-tugas ke Saya. Konteks repo: baca `AGENTS.md` +
...
> dikerjakan Saya dan ada di working tree branch `docs/brain-v4.1-alignment`.
...
1. **JANGAN mengubah rumus/logika** di `services/core-engine/app/tkg/`,
   ...
   STOP dan lapor — jangan "perbaiki" angkanya (Aturan Emas, SAYA.md §1).
2. **JANGAN push ke `main` dan JANGAN merge PR.** Branch → PR → tunggu review
   owner + Saya (SAYA.md §9).
...
`docs/BRAIN_ALIGNMENT.md`, `docs/prompts/PAAX_SAYA_PROMPT_TKG.md`.
...
schemas 11 passed, web build OK) + catatan "menunggu review owner + Saya".
