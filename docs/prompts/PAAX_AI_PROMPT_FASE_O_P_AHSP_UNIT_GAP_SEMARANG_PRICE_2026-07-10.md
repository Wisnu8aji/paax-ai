# PROMPT SAYA — Fase O/P: Tutup Gap Satuan AHSP (188 item) + Lanjutkan Harga Semarang

> Ditulis Saya, 2026-07-10. PR #32 (Fase M-2, perbaikan V-03 relatif) sudah
...
1. `SAYA.md` §1, §9 — kerja data AHSP/harga = domain Saya; Saya di sini
...
3. `report/REPORT_FASE_M_N_V03_FIX_AHSP_IMPORT_SAYA_2026-07-08.md` dan
   `report/REPORT_FASE_M2_V03_RELATIVE_FIX_SAYA_2026-07-09.md` — histori.
...
3. **Prioritas 3 — tidak terselesaikan**: kalau prioritas 1 & 2 sama-sama
   ...
   butuh keputusan Saya/owner", JANGAN dipaksakan isi asal.
...
2026.json` di prompt ini** — itu keputusan penerapan yang saya (Saya)
...
- **JANGAN** menerapkan/menulis nilai akhir (unit AHSP atau harga Semarang)
  ...
  saya (Saya) yang menerapkan setelah review, PERSIS pola Fase N.
