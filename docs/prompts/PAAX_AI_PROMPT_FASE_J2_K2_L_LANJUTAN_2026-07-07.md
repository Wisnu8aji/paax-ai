# PROMPT SAYA — Lanjutan: Navigasi RAB, Audit Validator Penuh, AHSP Auto-Suggest

> Ditulis Saya, 2026-07-07. Ini lanjutan dari
> `docs/prompts/PAAX_SAYA_PROMPT_FASE_J_GENERATE_RAB_WIRING_2026-07-06.md`
> (Fase J/K sudah dikerjakan Saya di PR #29, sudah diverifikasi ulang oleh
> Saya — lihat `report/REPORT_FASE_J_GENERATE_RAB_WIRING_SAYA_2026-07-06.md`).
...
> (Saya) **mengimplementasikan**, bukan cuma commit.

---

## 0. WAJIB BACA DULU

1. **`SAYA.md`** — Aturan Emas §1, pembagian tugas Saya/Saya §9, gerbang
...
4. **`docs/prompts/PAAX_SAYA_PROMPT_FASE_J_GENERATE_RAB_WIRING_2026-07-06.md`**
...
5. **`report/REPORT_FASE_J_GENERATE_RAB_WIRING_SAYA_2026-07-06.md`** — apa
...
DATA yang jadi tanggung jawab Saya per SAYA.md §9, bukan Saya — kalau
...
- Kalau ternyata V-03 SALAH menandai kasus ini sebagai error (false
  ...
  termasuk kategori SAYA.md §9 (perlu spek Saya dulu kalau memang mau
  diubah). **Tulis temuan ini di laporan akhir, tandai perlu keputusan
  Saya/owner, JANGAN diubah sendiri.**
...
**Baca `docs/prompts/PAAX_SAYA_PROMPT_FASE_J_GENERATE_RAB_WIRING_2026-07-06.md`
...
ke `main`, JANGAN merge sendiri. PR menunggu review owner + Saya.
...
3. **Temuan V-03** (§4) secara eksplisit — false positive atau tidak,
   dengan bukti test, dan apakah perlu keputusan lebih lanjut dari Saya/owner.
