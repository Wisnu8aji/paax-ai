# PROMPT SAYA — Task R9: Deploy & CI/CD — Cloud Run + Secret Manager + Staging

> Ditulis Saya, 2026-07-07, reasoning tinggi. Bagian dari
> `docs/prompts/PAAX_SAYA_ROADMAP_10_TASKS_NON_UI_2026-07-07.md` (Task 9).
...
- `services/document-intelligence/Dockerfile` **SUDAH ADA tapi RUSAK/USANG**:
  ...
  dipakai `.saya/launch.json`/dokumentasi lain), TIDAK menginstall
...
3. Tiap Dockerfile: multi-stage build (builder + runtime slim), non-root
   ...
   `8082` — cocokkan ke `.saya/launch.json` & README masing-masing).
...
Nama file baru: `report-remote/REPORT_TASKR9_DEPLOY_CICD_SAYA_<tanggal>.md`.
