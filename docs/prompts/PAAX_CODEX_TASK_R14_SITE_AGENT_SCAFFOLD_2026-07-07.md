# PROMPT CODEX — Task R14: Scaffold Site Agent v2.0 (API Progres Lapangan)

> Ditulis Claude, 2026-07-07, reasoning tinggi. Bagian dari
> `docs/prompts/PAAX_CODEX_ROADMAP_10_TASKS_NON_UI_2026-07-07.md` (Task 14).
...
`CLAUDE.md` §3/§4 sbg lapis "2C — Site Agent" dan halaman
...
(cek tidak konflik `.claude/launch.json`). Dependency: `paax-schemas`
...
persis "Vision-LLM v1.0 yang masih ditunda" yang `CLAUDE.md` §1.1 secara
...
Nama file baru: `report-remote/REPORT_TASKR14_SITE_AGENT_SCAFFOLD_CODEX_<tanggal>.md`.
...
- JANGAN sentuh `apps/web/**` — halaman site-agent frontend yang sudah
  ada TETAP pakai data mock sampai Claude yang wiring nanti.
