# PROMPT CODEX — Task 1/3: Verifikasi & Commit Pekerjaan X2 Bridging Non-Struktur (Dinding/Atap/Kusen/MEP)

> Ditulis Claude, 2026-07-05, reasoning tinggi. **Ini task PALING URGENT
...
> lanjut ke** `docs/prompts/PAAX_CODEX_TASK_02_BRIDGING_KUDA_KUDA_BAJA_PROFIL_2026-07-05.md`
...
UNCOMMITTED berikut (dikerjakan langsung oleh Claude sesi-sesi
sebelumnya, BUKAN Codex — lihat `docs/ai-map/STATE.md` §RANGKAIAN
...
Plus dokumentasi (`CLAUDE.md`, `AGENTS.md`, `docs/MASTER_PLAN.md`,
`docs/BRAIN_ALIGNMENT.md`, `docs/ai-map/*.md`, `docs/plans/*.md`,
`docs/strategy/*.md`) dan file baru di `docs/prompts/` +
`report-remote/REPORT_X2_*_CLAUDE_2026-07-05.md` (4 file: DINDING, ATAP,
KUSEN, MEP) + `report-remote/REPORT_FASE_X2_AI_ASSIST_BINDING_CLAUDE_2026-07-05.md`.
...
SUDAH ditulis, diuji manual (229 test lulus, dikonfirmasi Claude via
...
checkout/worktree yang berbeda dari sesi Claude sebelumnya): laporkan di
`report-remote/REPORT_TASK01_COMMIT_X2_BRIDGING_CODEX_<tanggal>.md` bahwa
...
diselesaikan (butuh Claude/owner memindahkan perubahan itu ke tempat yang
...
2. **Commit** perubahan itu — dipecah jadi BEBERAPA commit kecil logis
   ...
   - Commit 5: Slice MEP (`mep_assist.py`, `bridging_mep.py`, wiring,
     test).
   - Commit 6: Dokumentasi (`CLAUDE.md`, `AGENTS.md`, `docs/**`).
...
diperbaiki sendiri — laporkan di report, biarkan Claude/owner memutuskan
...
Claude terakhir verifikasi) — laporkan detail kegagalannya di report,
...
Nama file baru: `report-remote/REPORT_TASK01_COMMIT_X2_BRIDGING_CODEX_<tanggal>.md`.
...
`docs/prompts/PAAX_CODEX_TASK_02_BRIDGING_KUDA_KUDA_BAJA_PROFIL_2026-07-05.md`
