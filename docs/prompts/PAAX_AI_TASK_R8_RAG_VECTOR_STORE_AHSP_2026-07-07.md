# PROMPT SAYA — Task R8: RAG Grounding — Vector Store AHSP + Dokumen Proyek

> Ditulis Saya, 2026-07-07, reasoning tinggi. Bagian dari
> `docs/prompts/PAAX_SAYA_ROADMAP_10_TASKS_NON_UI_2026-07-07.md` (Task 8).
...
Nama file baru: `report-remote/REPORT_TASKR8_RAG_VECTOR_STORE_SAYA_<tanggal>.md`.
