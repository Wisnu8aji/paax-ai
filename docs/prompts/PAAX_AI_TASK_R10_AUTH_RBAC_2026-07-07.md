# PROMPT SAYA — Task R10: Auth & RBAC (estimator/PM/lapangan/owner)

> Ditulis Saya, 2026-07-07, reasoning tinggi. Bagian dari
> `docs/prompts/PAAX_SAYA_ROADMAP_10_TASKS_NON_UI_2026-07-07.md` (Task 10).
...
Nama file baru: `report-remote/REPORT_TASKR10_AUTH_RBAC_SAYA_<tanggal>.md`.
